...
if (typeof document !== 'undefined') {
  ...
  const seoMeta = [
    { name: 'description', content: 'FYLO is a document store that ships as a single self-contained binary with language shims for Python, Ruby, Node, Go, Rust, C#, Java, PHP, and Dart, plus local-first browser, mobile, and Flutter clients. One canonical JSON file per document, zero-payload prefix indexes, git-like version control, and SQL + REST APIs.' },
    { name: 'keywords', content: 'fylo, document store, nosql, filesystem, prefix index, sql, binary, cli, python, go, rust, java, csharp, database' },
    ...
    { property: 'og:description', content: 'One canonical file per document. Zero-payload prefix indexes. No monolithic caches.' },
    ...
    { name: 'twitter:description', content: 'One canonical file per document. Zero-payload prefix indexes. No monolithic caches.' },
  ]
