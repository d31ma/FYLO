...
export default class extends Tac {
    ...
    securityCode() {
        return [
            ...
            '',
            '# 2. Bind a developer-authenticated POSIX UID and mode to a record:',
            '# Native runtime only; browser clients must use an authenticated gateway.',
            ...
            '# mode is accepted only by put; uid-only puts default to 0o600.',
